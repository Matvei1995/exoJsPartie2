...
class Personnage {
  ...
  attaquer(attaquant) {
    ...
    console.log(
      `${this.nom} attaque ${attaquant.nom} et lui inflige ${degats} points de dégâts.`
    );
...
const joueur1 = new Personnage("Jean", 10, 8, 100);
const joueur2 = new Personnage("Pierre", 15, 6, 100);
